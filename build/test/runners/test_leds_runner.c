...
extern void test_StateLedOff(void);
extern void test_StateLed(void);
extern void test_ParamLed(void);
...
int main(void)
{
  ...
  run_test(test_TurnOnLedOne, "test_TurnOnLedOne", 31);
  run_test(test_TurnOffOneLed, "test_TurnOffOneLed", 38);
